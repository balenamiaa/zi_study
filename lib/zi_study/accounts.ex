defmodule ZiStudy.Accounts do
  ...
  alias ZiStudy.Accounts.{User, UserToken, UserNotifier}
  ...
  See `ZiStudy.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `ZiStudy.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  def profile_picture_path_base do
    Path.join([
      Application.app_dir(:zi_study, "priv"),
      "static",
      "uploads",
      "profile_pictures"
    ])
