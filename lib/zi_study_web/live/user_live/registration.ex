defmodule ZiStudyWeb.UserLive.Registration do
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: ZiStudyWeb.UserAuth.signed_in_path(socket))}
  end
  ...
  defp temp_upload_base_dir do
    Path.join([Application.app_dir(:zi_study, "priv"), "static", "uploads", "tmp"])
  end
