defmodule JustATemplateWeb.Layouts do
  @moduledoc """
  ...
  def app(assigns) do
    ...
    >
      <:logo_src>
        <img src={~p"/images/logo.svg"} alt="JustATemplate Logo" class="w-6 h-6" />
      </:logo_src>
      <:logo_text>
        <span class="text-lg font-bold">Just a Template Logo Text</span>
