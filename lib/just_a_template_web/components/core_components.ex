defmodule JustATemplateWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: JustATemplateWeb.Gettext
          ...
          <div :if={@current_user} class="dropdown dropdown-end">
            ...
            >
              <div class="w-10 rounded-full ring-2 ring-primary ring-offset-base-100 ring-offset-2 shadow-md group-hover:ring-offset-4 group-hover:shadow-lg transition-all duration-300 overflow-hidden">
                <img src={JustATemplate.Accounts.get_profile_picture_url(@current_user)} alt="Profile" />
              </div>
            </label>
            <div
              tabindex="0"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JustATemplateWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JustATemplateWeb.Gettext, "errors", msg, opts)
    end
  end
