defmodule JustATemplate.Accounts do
  @moduledoc """
  The Accounts context.
  """

  import Ecto.Query, warn: false
  alias JustATemplate.Repo

  alias JustATemplate.Accounts.{User, UserToken, UserNotifier}
  ...
  See `JustATemplate.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `JustATemplate.Accounts.User.password_changeset/3` for a list of supported options.
