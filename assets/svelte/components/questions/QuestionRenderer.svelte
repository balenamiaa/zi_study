...
<div class="question-container {isActive ? 'ring-2 ring-primary shadow-lg' : ''} bg-base-200 rounded-lg transition-all duration-300 border border-base-300">
    <div class="p-6">        
        <!-- Question Content -->
        {#if questionType === 'mcq_single'}
            <McqSingleQuestion data={question.data} {userAnswer} {submitAnswer} {clearAnswer} {questionNumber} />
        {:else if questionType === 'mcq_multi'}
            <McqMultiQuestion data={question.data} {userAnswer} {submitAnswer} {clearAnswer} {questionNumber} />
        {:else if questionType === 'true_false'}
            <TrueFalseQuestion data={question.data} {userAnswer} {submitAnswer} {clearAnswer} {questionNumber} />
        {:else if questionType === 'cloze'}
            <ClozeQuestion data={question.data} {userAnswer} {submitAnswer} {clearAnswer} {questionNumber} />
        {:else if questionType === 'written'}
            <WrittenQuestion data={question.data} {userAnswer} {submitAnswer} {clearAnswer} {questionNumber} />
        {:else}
